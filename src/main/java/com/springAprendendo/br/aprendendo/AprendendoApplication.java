...
import com.springAprendendo.br.aprendendo.domain.domain.enums.EstadoPagamento;
...
public class AprendendoApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat9 = new Categoria(null,"Frutos do mar");
		...
		Pagamento pegato1 = new PagamentoComCartao(null,EstadoPagamento.QUITADO,ped1,6);
		ped1.setPagamento(pegato1);
		...
		pagamentoRepository.saveAll(Arrays.asList(pegato1,pagato2));

		ItemPedido ip1 = new ItemPedido(ped1,p1,0.00,1,2000.00);
		ItemPedido ip2 = new ItemPedido(ped1,p3,0.00,2,80.00);
		ItemPedido ip3 = new ItemPedido(ped2,p2,100.00,1,800.00);

		ped1.getItemPedidoSet().addAll(Arrays.asList(ip1,ip2));
		ped2.getItemPedidoSet().addAll(Arrays.asList(ip3));

		p1.getItemPedidoSet().addAll(Arrays.asList(ip1));
		p2.getItemPedidoSet().addAll(Arrays.asList(ip3));
		p3.getItemPedidoSet().addAll(Arrays.asList(ip2));
